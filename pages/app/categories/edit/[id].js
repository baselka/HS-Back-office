...
const Index = () => {
  ...
  const { register, handleSubmit, watch, errors, setValue, reset } = useForm({
    defaultValues: { id: 0, type_name: "", type_desc: "" }
  });
    ...
    Api.Categories.details(category_id).then(res => {
      ...
      if (res.statusCode === 200) {
        ...
        NotificationManager.error(
          "حدث خطأ اثناء إسترجاع بيانات التصنيف",
          "عفواً",
          3000
        );
      }
  ...
  const _updateCategory = data => {
    Api.Categories.update(data).then(res => {
      ...
      if (res.statusCode === 202) {
        ...
        NotificationManager.error(
          "حدث خطأ اثناء تحديث بيانات التصنيف",
          "عفواً",
          3000
        );
      }
    ...
    <Container>
      {loadingData ? (
        ...
        <Layout>
          {categoryData === null ? (
            <div
              className='flex justify-center w-11/12 content-center'
                ...
                <form
                  ...
                  <Widget title='' className='mt-10 bg-gray-100 w-10/12'>
                    <div className='flex-col w-6/12 mb-4 ml-6 float-right'>
                      <div className='w-11/12 mb-12 p-5 bg-white border-2 border-gray-200'>
                        <label className='block'>
                          <span className='text-default'>
                            <b className='ml-1 text-s text-red-500'>*</b>الاسم
                            التصنيف
                          </span>
                          <input
                            name='type_name'
                            ...
                            className='form-input  text-xs block w-full bg-white placeholder-gray-400 mt-2'
                      ...
                      <div className='w-11/12 mb-12 p-5 bg-white border-2 border-gray-200'>
                        <label className='block'>
                          ...
                          <textarea
                            name='type_desc'
                            ref={register({ required: true })}
                            className='form-input  text-xs block w-full bg-white mt-2'
                      ...
                      <div className='w-11/12 mb-12 p-5 bg-white border-2 border-gray-200'>
                        <label className='block'>
                          <span className='text-default mb-2 block'>
                            صورة التصنيف
                          </span>
                        </label>
