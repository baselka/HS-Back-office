...
const DoughnutChart = ({title, subtitle, height = 260}) => {
  ...
  let defaultData = {
    labels: ['USA', 'China', 'Russia', 'Brazil'],
    datasets: [
      {
        data: [random(20, 100), random(20, 100), random(20, 100), random(20, 100)],
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex h-8 w-8 ltr:mr-4 rtl:ml-4">
            <div className="relative">
              ...
              <div
                className={`dropdown w-48 ${direction === 'ltr' ? 'dropdown-right' : 'dropdown-left'} ${
                  hidden ? '' : 'open'
                }`}>
